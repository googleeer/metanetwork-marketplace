  ...
  return (
    <>
      <LayoutAdmin
        headTitle="Activity"
        pageTitle="Activity"
        pageTitleSub={"Metanetwork Activity page"}
        pageClass={"admin"}
        parent={"Settings"}
        child={"Activity"}
      >
        ...
        <div className="row">
          <div className="col-xxl-12">
            ...
            <div className="card-header px-0">
              <h4 className="mb-0">Web Sessions</h4>

              <small>
                These sessions are currently signed in to your account. Sign out
                all other sessions
              </small>
            </div>
            ...
            <div className="card-header px-0">
              <h4 className=" mb-0">Confirmed Devices</h4>
              <small>
            ...
            <div className="card-header px-0">
              <h4 className=" mb-0">Account Activity</h4>
            ...
            <h4 className=" mb-3">Close Account</h4>
