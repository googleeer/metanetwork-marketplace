            ...
            <div className="row">
              <div className="col-xl-3 col-lg-6 col-md-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <h4 className="card-title">Chito x Givenchy</h4>
              ...
              <div className="col-xl-3 col-lg-6 col-md-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="notable-drops-content-img"></div>
                    <h4 className="card-title">The Space Cowboys</h4>
              ...
              <div className="col-xl-3 col-lg-6 col-md-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="notable-drops-content-img"></div>
                    <h4 className="card-title">Extra Dimensional </h4>
            ...
            <div className="row justify-content-center">
              <div className="col-xl-8">
                <div className="section-title text-center">
                  ...
                  <p>
                    Here are a few reasons why you should choose Metanetwork
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="create-sell-content">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      Metanetwork by clicking the wallet icon in the top right
