          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-xl-6 col-md-6 py-md-5">
              <div className="intro-content my-5 text-center">
                <h1>Metanetwork - NFT Marketplace React Nextjs App</h1>
                <p>
                  Metanetwork is the complete UX & UI dashboard for NFT. Here
                  included bids, collection, wallet, and all user setting pages
                  including profile, application, activity, payment method, api,
                  sign in & sign up etc.
                </p>
              </div>
              <div className="intro-demo_img">
                <img src="/images/demo/home.jpg" alt="" className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="col-md-6">
              <div className="customer-support-content">
                ...
                <a href="https://api.whatsapp.com/send?phone=008801843666660">
                  Send Message <i className="la la-angle-right"></i>
                </a>
              </div>
            </div>
            <div className="col-md-6">
              <div className="customer-support-content">
                ...
                <a href="skype:profile_name?sporsho9">
                  Add Skype <i className="la la-angle-right"></i>
                </a>
              </div>
            </div>
            <div className="col-md-6">
              <div className="customer-support-content">
                ...
                <a href="mailto:imsaifun@gmail.com">
                  Send Email <i className="la la-angle-right"></i>
                </a>
              </div>
            </div>
            <div className="col-md-6">
              <div className="customer-support-content">
                ...
                <a href="https://docs.google.com/forms/d/1KjSr2pRP9GSydodBYOz05ke6faVX0MgFCAznaYdKl6E">
                  Hire Now <i className="la la-angle-right"></i>
                </a>
              </div>
            </div>
          </div>
