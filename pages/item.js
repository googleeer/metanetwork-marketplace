  ...
  return (
    <>
      <LayoutFront
        ...
        pageTitleSub={"Metanetwork Item Details page"}
        pageClass={"front"}
        parent={"Home"}
        child={"Item Details"}
      >
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="d-flex justify-content-between mt-4 mb-4">
                          <div className="text-start">
                            <h4 className="mb-2">Auction Time</h4>
                        ...
                        <p className="mb-3">
                          ...
                          elit. Eos, unde. Unde, doloremque ipsam? Nesciunt
                          dolorem nisi quae nostrum veniam quasi illum, iusto
                          tempore nihil, natus perspiciatis? Sed
                        </p>
