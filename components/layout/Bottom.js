          ...
          <div className="row">
            <div className="col-xl-4 col-lg-4 col-md-7 col-sm-8">
              <div className="bottom-logo">
                <img className="pb-3" src="/images/logo-sm.png" alt="" />

                <p>
                  METANETWORK an ecosystem that will unite GameFi, eSports, NFT
                  and give everyone the opportunity to earn in the world of NFT
                  by creating, selling, buying and collecting NFT tokens in one
                  Meta Network.
                </p>
              </div>
            </div>
